              ...
              .append("xhtml:body")
                ...
                .html(function(d) {
                  if (d.level === "mid") {
                    ...
                    return "<div class='artifact'><div class='artifact-text'><h3>" + d.nodeName + "</h3><p>"+ d.description+ "</p><p> " + d.dateCreated + "</p><p> " + d.collection + "</p><p> " + "put agents here" + "</p><p> " + d.typeOfWork + "</p></div><div class='tree-image' style=''><img src=" + d.imageURI + "></img></div></div>";
                  }
                })
                  .on("click", function(d) {
                    if (d.level === "last") {
