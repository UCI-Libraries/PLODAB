              ...
              .append("xhtml:body")
                ...
                .html(function(d) {
                  if (d.level === "mid") {
                    ...
                    return "<div class='artifact'><div class='tree-image' style=''><img src=" + d.imageURI + "></img></div><div class='artifact-text'><h3>"+ d.nodeName + "</h3><div class='artifact-desc'>"+ d.description+ "</div><p>Date Created: " + d.dateCreated + "</p><p><a href=''>See this artist's book's complete record on Calisphere</a></p><p>Agents: " + d.agents + "</p></div></div>";
                  }
                })
                  .on("click", function(d) {
                    if (d.level === "last") {
