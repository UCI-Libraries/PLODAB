        ...
        function update(source) {
              ...
              .append("xhtml:body")
                ...
                .html(function(d) {
                  if (d.level === "mid") {
                    ...
                    return "<div class='artifact'><div class='tree-image' style=''><img src=" + d.imageURI + "></img></div><div class='artifact-text'><h3>" + d.nodeName + "</h3><p>"+ d.description+ "</p><p> " + d.dateCreated + "</p><p> " + d.collection + "</p><p> " + "put agents here" + "</p><p> " + d.typeOfWork + "</p></div></div>";
                    //  return "<div class='tree-node artifact' style='display: table; width: "+ d.width +"px; height: 150px;'><div class='tree-text' style='color:grey; width: 500px; display:table-cell; text-align: center; vertical-align: top; float:right'><h3 style='padding:5px;margin:0px'>" + d.nodeName + "</h3><p>"+ d.description+ "</p><p> " + d.publicationDate + "</p><p> " + d.collection + "</p><p> " + d.publisher + "</p><p> " + d.typeOfWork + "</p></div><div class='tree-text' style='color:grey; display:table-cell; text-align: center; vertical-align:top; width:28%; border:1px grey solid; height:" + (d.height - 12 )+ "px; float:left; padding:5px; background-color: " + "white" + ";'>"+"IMAGE THUMB"+"</div></div>";
                  }
                })
                  .on("click", function(d) {
                    if (d.level === "last") {
            ...
            nodeUpdate.select("rect")
                ...
                .style("fill", function (d) {
                  ...
                  var parentName = "";
                  //TODO: check if children, grey out if no.
                  if (d.parent) {
                    parentName = d.parent.nodeName.toLowerCase().replace(/\s/g, '_');
                  }
                  var colorNames = Object.keys(plodabColors);
