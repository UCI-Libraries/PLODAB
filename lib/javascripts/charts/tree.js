              ...
              .append("xhtml:body")
                ...
                .html(function(d) {
                  if (d.level === "mid") {
                    ...
                    return "<div class='tree-node mid' style='display: table; width: "+ d.width +"px; height: 95px;'><p class='tree-text' style='color:#28241E ;display: table-cell; text-align: center; vertical-align: middle;'>" + d.nodeName + "</p></div>";
                  } else if ( d.level === "last") {
                    return "<div class='tree-node last' style='display: table; width: 100px; height: 65px;'><p class='tree-text' style='color:#28241E; display: table-cell; text-align: center; vertical-align: middle;'>" + d.nodeName + "</p></div>";
                  } else {
                    return "<div class='artifact'><div class='tree-image' style=''><img alt='Photograph featuring "+d.name+"' src=" + d.imageURI + "></img></div><div class='artifact-text'><h2>"+ d.nodeName + "</h2><div class='artifact-desc'>"+ d.description+ "</div><p>Date Created: " + d.dateCreated + "</p><p>Agents: " + d.agents + "</p><p><a target='_blank' href="+ d.calisphereURI +">See this artist's book's complete record on Calisphere</a></p></div></div>";
                  }
                })
                  .on("click", function(d) {
                    if (d.level === "last") {
