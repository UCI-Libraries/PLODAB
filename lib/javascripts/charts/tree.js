              ...
              .append("xhtml:body")
                ...
                .html(function(d) {
                  if (d.level === "mid") {
                    ...
                    return "<div class='tree-node last' style='display: table; width: 100px; height: 50px;'><p class='tree-text' style='color:dark grey; display: table-cell; text-align: center; vertical-align: middle;'>" + d.nodeName + "</p></div>";
                  } else {
                    return "<div class='tree-node artifact' style='display: table; width: "+ d.width +"px; height: 150px;'><div class='tree-text' style='color:grey;display:table-cell; text-align: center; vertical-align: top;width:70%; float:right'><h3 style='padding:5px;margin:0px'>" + d.nodeName + "</h3><p>"+ d.description+ "</p><p> " + d.dateCreated + "</p><p> " + d.collection + "</p><p> " + "put agents here" + "</p><p> " + d.typeOfWork + "</p></div><div class='tree-text' style='color:grey; display:table-cell; text-align: center; vertical-align:top; width:28%; border:1px grey solid; height:" + (d.height - 12 ) + "px; float:left; padding:5px; background-color: " + "white" + ";'><img src=" + d.imageURI + "></img></div></div>";
                  }
                });
          ...
          if (d.level === "mid") {
            ...
            activeNodes.forEach( function(d) {
              if (d.children) {
                ...
                console.log("What isn't being caught?", d);
              }
            });
            if (count * 120 > 900) {
