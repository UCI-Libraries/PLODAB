...
(function(){
  ...
  var chart = function(selection) {
    ...
    tipTemplate = function(d) {
      if (d.null !== true ) {
        if (d.imageURI) {
          return "<div class='tip-agent'>" + d.agent + "</div><div class='tip-content'><img alt='Photograph featuring "+d.name+"' class='d3-tip-img' src=" + d.imageURI + "><span class='tip-title'>" + clippedName(d.name) + "</span></div><br>";
        } else {
          return "<div class='tip-agent'>" + d.agent + "</div><div class='tip-content'><img alt='book icon' class='d3-tip-img' src='lib/images/book.svg'><span class='tip-title'>" + clippedName(d.name) + "</span></div><br>";
        }
      } else {
