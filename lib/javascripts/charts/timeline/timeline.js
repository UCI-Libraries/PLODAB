...
(function(){
  Timeline = function() {
  console.log("TL", window.innerWidth);
  ...
  var chart = function(selection) {
    ...
    tipTemplate = function(d) {
      if (d.null !== true ) {
        if (d.imageURI) {
          return "<div class='tip-agent' style='color:whitesmoke'>" + d.agent + "</div><div class='tip-content'><img class='d3-tip-img' src=" + d.imageURI + "><span class='tip-title' style='color:whitesmoke'>" + d.name.name + "</span></div><br>";
        } else {
          return "<div class='tip-agent' style='color:whitesmoke'>" + d.agent + "</div><div class='tip-content'><img class='d3-tip-img' src='lib/images/book.svg'><span class='tip-title' style='color:whitesmoke'>" + d.name.name + "</span></div><br>";
        }
      } else {
