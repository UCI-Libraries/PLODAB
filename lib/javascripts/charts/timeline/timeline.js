...
(function(){
  ...
  var chart = function(selection) {
      ...
      data.forEach(function(d) {
        ...
        d.books = Object.keys(d).map(function(name) {
          if (name != "year") {
            ...
            return {name: d[name], imageURI: calisphereUriPath + imgArkStore[d[name].imageURI], selected: d[name].selected, y0: y0, y1: y0 += bookHeight};
          }
          else {
    ...
    tipTemplate = function(d) {
      console.log("IN tipTemplate", d);
      return "<div class='tip-content'><img class='d3-tip-img' src=" +d.imageURI+ "><span style='color:white'>" + d.name.name+ "</span></div>";
    };
