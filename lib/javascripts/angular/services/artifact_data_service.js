    ...
    this.getArtifactData = function(callback, data) {
      ...
      function makeArtifactData(data) {
        ...
        keys.forEach( function(key) {
          ...
          // console.log(data[key]);
          // console.log(data[key].agents);

          artifactStore[key] = {};
          artifactStore[key].key = key;
          artifactStore[key].dateCreated = data[key].dateCreated;
          artifactStore[key].descriptions = data[key].descriptions;
          // artifactStore[key].subjects = data[key];
          // artifactStore[key].collection = data[key];
          // artifactStore[key].publicationDate = data[key];
          // artifactStore[key].descriptions = data[key];
          artifactStore[key].calisphereUri = data[key].calisphereUri;
          artifactStore[key].imageURI = calisphereUriPath + "3e7f91025c3bb908646f21c01a7567d6";       artifactStore[key].height = 300;
      ...
      function sourcePlaceofPublication(book) {
        ...
        book.techniques.forEach( function(placeOfPublication) {
          var subjObj = {
            name: placeOfPublication,
            height: 50,
            width: 100,
            level: "last"};
          placeOfPublicationArr.push(placeOfPublication);
        });
