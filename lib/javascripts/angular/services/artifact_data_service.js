    ...
    this.getArtifactData = function(callback, data) {
      ...
      var promise = new Promise(
        function(resolve, reject) {
          ...
          // console.log(Object.keys(agentsStore).length);
          // Object.keys(agentsStore).forEach(function(agent) {
          //   if (agentsStore[agent].count > 1 ) {
          //     console.log(agent, agentsStore[agent].count);
          //   }
          // });
      ...
      function makeArtifactData(data) {
        ...
        keys.forEach( function(key) {
          ...
          artifactStore[key].typeOfWork = "MooBooGooBoo";
          artifactStore[key].imageURI = calisphereUriPath + "3e7f91025c3bb908646f21c01a7567d6";
