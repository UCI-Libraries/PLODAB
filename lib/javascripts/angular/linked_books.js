  ...
  angular.module('plodab')
    .controller('chartctrl', ['$scope', '$timeout', 'dataService', 'timelineDataService', 'bubbleDataService', function ($scope, $timeout, dataService, timelineDataService, bubbleDataService) {
      ...
      function init() {
        ...
        $scope.topicButtons = [
          {name: "subjects", display: "Subjects", color: $scope.colors.subjects, background_color: $scope.colors.background_color},
          {name: "materials", display: "Materials", color: $scope.colors.materials, background_color: $scope.colors.background_color},
          {name: "techniques", display: "Techniques", color: $scope.colors.techniques, background_color: $scope.colors.background_color},
          {name: "place_of_publication", display: "Place of Publication", color: $scope.colors.place_of_publication, background_color: $scope.colors.background_color}
        ];
